...
SWEP.Primary.Damage                = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and 30 * TFA.Yankys_Custom_Weapon_Pack.DamageMultiplier or 13.45
...
SWEP.Primary.RPM                   = 335                       -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.SpreadIncrement       = 3.5                       -- What percentage of the modifier is added on, per shot.  Example val: 1/3.5
...
SWEP.IronSightsPos_2XRDS    = Vector(-2.39, 0, 0.25)
SWEP.IronSightsAng_2XRDS    = Vector(0, -0.015, 0)
SWEP.RTScopeFOV_2XRDS       = 40

SWEP.IronSightsPos_C79      = Vector(-2.39, 0.5, 0.21)
...
SWEP.Attachments = {
	...
	[3] = { atts = { "remington_870_barrel_long", "remington_870_barrel_short" } },
	[4] = { atts = { "ins2_ub_laser", "ins2_laser_anpeq15_black", "ins2_laser_anpeq15_tan", "ins2_ub_flashlight" } },
	[5] = { atts = { "remington_870_foregrip" } },
	[6] = { atts = { "tfa_tactical_point_shooting" } },
	[7] = { atts = { "tfa_yanks_wpn_pack_heavy_stock", "tfa_yanks_wpn_pack_light_stock", "bo2_stock", "remington_870_nostock" } },
