...
SWEP.Manufacturer           = "Tulsky Oruzheiny Zavod"        -- Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Type                   = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and "Type: Bolt-Action Rifle - Caliber: 7.62x54mmR - Muzzle Velocity: 853 m/s" or "Bolt-Action Rifle"
SWEP.Purpose				= "A soviet 7.62x54MMR Rifle."    -- Purpose Tooltip
SWEP.Instructions		    = ""    
...
SWEP.Primary.Sound          = Sound("TFA_INS2.Mosin.Fire")            -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound  = Sound("TFA_INS2.Mosin.Fire_Suppressed") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.Damage                = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and 145 * TFA.Yankys_Custom_Weapon_Pack.DamageMultiplier or 145
SWEP.Primary.DamageTypeHandled     = true                     -- true will handle damagetype in base
SWEP.Primary.DamageType            = nil                      -- See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.  Leave nil to autodetect.  DMG_AIRBOAT opens doors.
SWEP.Primary.PenetrationMultiplier = 0.88                     -- Change the amount of something this gun can penetrate through
...
SWEP.Primary.IronAccuracy        = .00085                     -- Ironsight accuracy, should be the same for shotguns

--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
SWEP.Primary.SpreadMultiplierMax = 5                          -- How far the spread can expand when you shoot. Example val: 2.5
SWEP.Primary.SpreadIncrement     = 3.8                        -- What percentage of the modifier is added on, per shot.  Example val: 1/3.5
SWEP.Primary.SpreadRecovery      = 2.3                        -- How much the spread recovers, per second. Example val: 3
...
SWEP.Primary.RangeFalloffLUT = {
	...
	lut = {
		...
		{range = 550, damage = 1},
		{range = 550, damage = 1},
		{range = 1000, damage = 0.8},
		{range = 1000, damage = 0.8},
		{range = 1000, damage = 0.8},
		{range = 1500, damage = 0.5},
		{range = 1853, damage = 0.5},
	}
}
...
SWEP.IronSightsMoveSpeed         = SWEP.MoveSpeed  * 0.82     -- Multiply the player's movespeed by this when sighting.
...
SWEP.MuzzleFlashEffect           = ( TFA and TFA.YanKys_Realistic_Muzzleflashes ) and "tfa_muzzleflash_sv98" or "tfa_muzzleflash_shotgun"
...
SWEP.ViewModel			  = "models/weapons/c_ins2_mosin_nagant.mdl"
SWEP.ViewModelFOV	      = 70		                          -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip	      = false		                      -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands             = true                              -- Use gmod c_arms system.
SWEP.VMPos                 = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and Vector(-0.8, 0, 0.25) or Vector(0, 0, 0.25)
...
SWEP.SequenceLengthOverride = {                               -- Changes both the status delay and the nextprimaryfire of a given animation
	[ACT_VM_PULLBACK_LOW]   = 44 / 30,
	[ACT_VM_PULLBACK_HIGH]  = 51 / 30,
}   
...
SWEP.WorldModel	   = "models/weapons/w_ins2_mosin_nagant.mdl" -- Weapon world model path
...
SWEP.IronSightsAng        = Vector(0.035, 0.02, 0)

SWEP.IronSightsPos_Point_Shooting = Vector(-5.5, -4, -1)
SWEP.IronSightsAng_Point_Shooting = Vector(0, 0, -30)
SWEP.Secondary.Point_Shooting_FOV = 70 

SWEP.IronSightsPos_Kobra  = Vector(-3.1, -6.25, -0.4)
SWEP.IronSightsAng_Kobra  = Vector(0.15, 0, 0)

SWEP.IronSightsPos_EOTech =  Vector(-3.1, -6.25, -0.65)
SWEP.IronSightsAng_EOTech = Vector(0.02, 0, 0)

SWEP.IronSightsPos_RDS    = Vector(-3.1, -6.25, -0.7)
SWEP.IronSightsAng_RDS    = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS  = Vector(-3.095, -8, -0.71)
SWEP.IronSightsAng_2XRDS  = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 70
SWEP.RTScopeFOV_2XRDS        = 25

SWEP.IronSightsPos_Mosin  = Vector(-3.076, -7, 0.25)
SWEP.IronSightsAng_Mosin  = Vector(-0.0275, -0.0265, 0)
SWEP.RTScopeFOV_Mosin     = 45

SWEP.IronSightsPos_C79    = Vector(-3.1, -9, -0.76)
SWEP.IronSightsAng_C79    = Vector(-0.0275, -0.012, 0)
SWEP.RTScopeFOV_C79       = 50

SWEP.IronSightsPos_PO4X   = Vector(-3.02, -10, -0.2)
SWEP.IronSightsAng_PO4X   = Vector(-0.0275, -0.022, 0)
SWEP.RTScopeFOV_PO4X      = 50

SWEP.IronSightsPos_MX4    = Vector(-3.105, -10, -0.48)
SWEP.IronSightsAng_MX4    = Vector(-0.045, -0.008, 0)

SWEP.IronSightsPos_PU_Mosin = Vector(-3.076, -7, 0.25)
SWEP.IronSightsAng_PU_Mosin = Vector(-0.0275, -0.0265, 0)
...
SWEP.Attachments = {
	[1] = { atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79", "ins2_si_mosin", "ins2_si_po4x", "ins2_si_mx4" } },
	[2] = { atts = { "ins2_br_heavy", "r6s_h_barrel", "r6s_muzzle_2", "r6s_flashhider_2", "bo2_longbarrel", "ins2_br_supp" } },
...
SWEP.AttachmentDependencies = {	["tfa_tactical_point_shooting"] = {"ins2_ub_laser", "ins2_laser_anpeq15_black", "ins2_laser_anpeq15_tan", "ins2_ub_flashlight", "ins2_eft_lastac2"}, }--{["si_acog"] = {"bg_rail"}}
SWEP.AttachmentExclusions   = {}

SWEP.ViewModelBoneMods = {
	["A_Muzzle"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, -90) },
	["A_Modkit"] = { scale = Vector(1.125, 1.125, 1.125), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["A_Suppressor"] = { scale = Vector(0.95, 0.95, 0.95), pos = Vector(0, -0.5, 0), angle = Angle(0, 0, 0) },

--	["R UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["Bullet02"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0.075), angle = Angle(0, 0, 0) },
	["R Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -3, 0) },
	["R Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -50, 0) },
	["R Finger2"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -50, 0) },
	["R Finger3"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -50, 0) },
	["R Finger4"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -50, 0) },
}
...
SWEP.VElements = {
	["rail_sights"] = { type = "Model", model = "models/weapons/upgrades/a_modkit_mosin_nagant.mdl", bone = "A_Modkit", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	...
	["scope_pu_mosin"] = { type = "Model", model = "models/weapons/upgrades/a_optic_pu_scope.mdl", bone = "A_Optic", rel = "", pos = Vector(0.05, 0, 0), angle = Angle(90, 0, 90), size = Vector(1.3, 1.3, 1.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
...
SWEP.WElements = {
	...
	["scope_pu_mosin"] = { type = "Model", model = "models/weapons/tfa_ins2/w_optic_pu_scope.mdl", bone = "ATTACH_ModKit", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
...
if TFA.Yankys_Custom_Weapon_Pack then
    ...
    SWEP.AmmoTypeStrings = {
	    sniperpenetratedround = "7.62x54mmR 7N1 AP"
    }
