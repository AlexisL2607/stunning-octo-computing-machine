...
if CLIENT then
SWEP.PrintName				= "MK18"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.MK18.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2.MK18.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_mk18.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_mk18.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.307, -4, 0.955)
SWEP.IronSightsAng = Vector(0.25, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-3.295, -2, 0.463)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_Kobra = 65

SWEP.IronSightsPos_EOTech = Vector(-3.295, -4, 0.677)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_EOTech = 76

SWEP.IronSightsPos_RDS = Vector(-3.295, -4, 0.601)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_RDS = 58

SWEP.IronSightsPos_2XRDS = Vector(-3.292, -3.5, 0.598)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 59

SWEP.IronSightsPos_C79 = Vector(-3.294, -4, 0.555)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_C79 = 70

SWEP.IronSightsPos_PO4X = Vector(-3.201, -4, 1.212)
SWEP.IronSightsAng_PO4X = Vector(-2, 0.35, 0)
SWEP.Secondary.IronFOV_PO4X = 64
SWEP.ScopeAngleTransforms_PO4X = Angle(2.05, -0.37, 0)
SWEP.RTOverlayTransforms_PO4X = {-0.085, -0.5}
...
SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_standard_mk18.mdl", bone = "A_Optic", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	...
	["standard2"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_standard2_mk18.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(-0.29, 0, 0), angle = Angle(0, 0, 180), size = Vector(0.76, 0.76, 0.76), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true },
	["standard3"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_standard3_mk18.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(-0.29, 0, 0), angle = Angle(0, 0, 180), size = Vector(0.76, 0.76, 0.76), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
...
SWEP.WElements = {
	...
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_flipup2.mdl", bone = "ATTACH_Standard", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
...
if CLIENT then
	function SWEP:Think2( ... )
		local laser = self:GetStat("VElements.laser.active")
		self.VElements["standard2"].active = not laser
		self.VElements["standard3"].active = laser
