...
SWEP.Primary.GLSound        = Sound("TFA_INS2_2530.1")                -- This is the sound of the grenade launcher, when you shoot.
...
SWEP.ViewModelPunch_VertialMultiplier            = 0.95        -- Default value is 1
SWEP.ViewModelPunch_VertialMultiplier_IronSights = 0.32        -- Default value is 0.25

SWEP.ViewModelPunchYawMultiplier                 = 0.43        -- Default value is 0.45
SWEP.ViewModelPunchYawMultiplier_IronSights      = 1.2         -- Default value is 1.5

SWEP.Primary.Damage                = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and 65 * TFA.Yankys_Custom_Weapon_Pack.DamageMultiplier or 48
SWEP.Primary.DamageTypeHandled     = true                      -- true will handle damagetype in base
SWEP.Primary.DamageType            = nil                       -- See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.  Leave nil to autodetect.  DMG_AIRBOAT opens doors.
SWEP.Primary.PenetrationMultiplier = 0.935                     -- Change the amount of something this gun can penetrate through
...
SWEP.Primary.KickDown            = 0.50                        -- This is the maximum downwards recoil (skeet)
...
-- Firing Cone Related
SWEP.Primary.Spread              = 0.039                       -- This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy        = 0.0065                      -- Ironsight accuracy, should be the same for shotguns

-- Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
SWEP.Primary.SpreadMultiplierMax = 2.23                        -- How far the spread can expand when you shoot. Example val: 2.5
...
SWEP.IronSightsPos_Kobra  = Vector(-2.92, -1, -0.53)
...
SWEP.IronSightsPos_EOTech = Vector(-2.92, -1, -0.8)
SWEP.IronSightsAng_EOTech = Vector(0.125, -0.012, 0)

SWEP.IronSightsPos_2XRDS  = Vector(-2.9, -1.25, -0.78)
SWEP.IronSightsAng_2XRDS  = Vector(0, 0, 0)
SWEP.RTScopeFOV_2XRDS     = 35

SWEP.IronSightsPos_C79    =  Vector(-2.9075, -1.25, -0.92)
SWEP.IronSightsAng_C79    = Vector(0, 0, 0)
SWEP.RTScopeFOV_C79       = 45

SWEP.IronSightsPos_PO4X   = Vector(-2.84, -1.25, -0.435)
