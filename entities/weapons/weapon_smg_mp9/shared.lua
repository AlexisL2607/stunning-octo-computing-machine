...
SWEP.Primary.Damage                = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and 38 * TFA.Yankys_Custom_Weapon_Pack.DamageMultiplier or 28
...
SWEP.Primary.KickDown              = 0.242                     -- This is the maximum downwards recoil (skeet)
...
SWEP.Primary.SpreadMultiplierMax   = 2.7                       -- How far the spread can expand when you shoot. Example val: 2.5
SWEP.Primary.SpreadIncrement       = 0.25                      -- What percentage of the modifier is added on, per shot.  Example val: 1/3.5
SWEP.Primary.SpreadRecovery        = 3.22                      -- How much the spread recovers, per second. Example val: 3
...
SWEP.Primary.RangeFalloffLUT = {
	...
	lut = {
		...
		{range = 200, damage = 1},
		{range = 200, damage = 1},
		{range = 250, damage = 0.8},
		{range = 300, damage = 0.57},		
	}
}
...
SWEP.IronSightsPos_2XRDS  = Vector(-2.65, -2, 0.68)
...
SWEP.IronSightsPos_C79    =  Vector(-2.658, -2, 0.55)
...
SWEP.Attachments = {
	...
	[5] = { atts = { "tfa_yanks_wpn_pack_heavy_stock", "tfa_yanks_wpn_pack_light_stock", "bo2_stock", "warface_bt_mp9_folded_stock", } },
