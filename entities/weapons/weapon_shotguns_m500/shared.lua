...
if CLIENT then
SWEP.PrintName				= "M500"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM_Displayed = 160 -- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM = 60 / (10 / 28) -- This is in Rounds Per Minute / RPM
...
SWEP.Attachments = {
	...
	[8] = { atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79", "ins2_si_po4x" }, order = 2 },
	[9] = { atts = { "ins2_fg_grip" }, order = 3 },
	[6] = { atts = { "ins2_ub_laser" }, order = 4 },
	[7] = { atts = { "ins2_m500_black", "ins2_m500_haunted" }, order = 6 },
}
