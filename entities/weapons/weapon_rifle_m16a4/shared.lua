...
SWEP.Author				= "Hunter & Mendes" --Author Tooltip
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapon_M16A4.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("weapon_M16A4.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2_m16_kryptek/v_m16a3.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2_m16/w_m16.mdl" -- Weapon world model path
...
SWEP.ViewModelBoneMods = {
	...
	["A_LaserFlashlight"] = { scale = Vector(1.1,1.1,1.1), pos = Vector(1.1, -5, 0), angle = Angle(0,180,180) },
	["A_Optic"] = { scale = Vector(.9,.9,.9), pos = Vector(0, -.3, 0), angle = Angle(0,0,0) },
...
SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2_m16_kryptek/a_carryhandle_m16.mdl", bone = "A_Optic", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
...
SWEP.WElements = {
	...
	--["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_flipup3.mdl", bone = "ATTACH_ModKit", rel = "ref", pos = Vector(-4.433, 0.041, 4.947), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true },
