...
if CLIENT then
SWEP.PrintName				= "M40A5"		-- Weapon name (Shown on HUD)	
...
SWEP.Gun = ("tfa_ins2_m40a5") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/v_m40a5_tfa.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_m40a5_tfa.mdl"	-- Weapon world model
...
SWEP.Primary.Sound			= Sound("weapons/tfa_ins2_m40a5/m40a1_fp.wav")
SWEP.Primary.SilencedSound			= Sound("weapons/tfa_ins2_m40a5/m40a1_suppressed_fp.wav")		-- Script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.81, 0, 0.588)
SWEP.IronSightsAng = Vector(0.495, 0, 0)
SWEP.IronSightsPos_EOTech = Vector(-2.81, 0, -0.128)
SWEP.IronSightsAng_EOTech = Vector(0.495, 0, 0)
SWEP.IronSightsPos_RDS = Vector(-2.81, 0, -0.128)
SWEP.IronSightsAng_RDS = Vector(0.495, 0, 0)
SWEP.IronSightsPos_2XRDS = Vector(-2.81, 0, -0.018)
SWEP.IronSightsAng_2XRDS = Vector(0.205, 0, 0)
SWEP.IronSightsPos_C79 = Vector(-2.81, -2.4, -0.418)
SWEP.IronSightsAng_C79 = Vector(0.105, 0, 0)
SWEP.IronSightsPos_PO4X = Vector(-2.735, -1.9, 0.145)
SWEP.IronSightsAng_PO4X = Vector(0, 0, 0)
SWEP.IronSightsPos_Kobra = Vector(-2.815, 0, 0.109)
SWEP.IronSightsAng_Kobra = Vector(0.495, 0, 0)
SWEP.IronSightsPos_Mosin = Vector(-2.784, 0, 0.580)
SWEP.IronSightsAng_Mosin = Vector(0.095, 0, 0)
SWEP.IronSightsPos_MX4 = Vector(-2.821, 0, 0.455)
...
SWEP.WorldModelBoneMods = {
        ["ATTACH_Laser"] = { scale = Vector(1.2, 1.2, 1.2), pos = Vector(0, -0.4, 0), angle = Angle(0, 0, 0) },
...
SWEP.WElements = {
	["ref"] = { type = "Model", model = SWEP.WorldModel, bone = "oof", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
        ["sights_folded"] = { type = "Model", model = "models/weapons/upgrades/w_standard_m40a5.mdl", bone = "M40_LP", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.4, 0.4, 0.4), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
...
SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/upgrades/a_standard_m40a5.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 180), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
        ["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec2.mdl", bone = "A_Suppressor", rel = "", pos = Vector(-2.609, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_band.mdl", bone = "A_UnderBarrel", rel = "", pos = Vector(0.008, -5.415, 0.56), angle = Angle(0, 90, 0), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false }
}
