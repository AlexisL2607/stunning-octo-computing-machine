...
function drawIndicatorIcons()
    ...
    local iconStart = 20
    local health, food, water, stamina, armor = LocalPlayer():Health(), LocalPlayer().Hunger, LocalPlayer().Thirst, LocalPlayer().Stamina
...
function drawPlayerHud()
    ...
    if LocalPlayer().Money then
        ...
        draw.DrawText("Armor "..LocalPlayer():Armor(), "TargetIDMedium", SW - 1750, SH - 25, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER)
    end
end
...
function DrawPickups()
    ...
    dropTypes["backpack"] = {"PRESS 'E' TO LOOT BACKPACK", "BACKPACK"}
   	...
   	dropTypes["medshop"] = {"PRESS 'E' TO ACCESS MEDSHOP", "SAFE ZONE MEDSHOP"}
    if UseNewShop then
