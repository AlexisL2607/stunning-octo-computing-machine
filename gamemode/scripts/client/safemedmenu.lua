function MedShopMenu()
    ...
    DFrame_ShopMenu.Paint = function()
        ...
        draw.DrawText("Medecine Shop", "DebugFixedLarge", 10, 10, Color(255, 255, 255, 255), TEXT_ALIGN_LEFT)
    end
    ...
    local PanelPosX = 11
    local PanelPosY = 22
    DPanel_Food_Tab = vgui.Create("DPanel")
    ...
    local shopMenuPanels = {DPanel_Food_Tab,DPanel_Equipment_Tab, DPanel_Survival_Tab, DPanel_Perk_Tab, DPanel_Sell_Tab}
    ...
    DPropSheet_Shop:AddSheet("Food & Drink", DPanel_Food_Tab, "icon16/money.png", true, true, "Purchase Food & Drinks")
    DPropSheet_Shop:AddSheet("Survival Gear", DPanel_Survival_Tab, "gui/silkicons/cart", true, true, "Purchase Basic Survivable Items")
    DPropSheet_Shop:AddSheet("Crafting Materials", DPanel_Equipment_Tab, "gui/silkicons/bullet_black", true, true, "Purchase Materials")
    ...
    shopTab(DPanel_Food_Tab, "shop_food")
    shopTab(DPanel_Equipment_Tab, "shop_barricades")
...
net.Receive("OpenMedShop", function(len) MedShopMenu() end)
