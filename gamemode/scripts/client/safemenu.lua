function ShopMenu()
    ...
    DPanel_Weapon_pistols_Tab = vgui.Create("DPanel")
    DPanel_Weapon_smg_Tab = vgui.Create("DPanel")
    DPanel_Weapon_shotguns_Tab = vgui.Create("DPanel")
    DPanel_Weapon_rifles_Tab = vgui.Create("DPanel")
    DPanel_Weapon_snipers_Tab = vgui.Create("DPanel")
    DPanel_Ammo_Tab = vgui.Create("DPanel")
    DPanel_Armor_Tab = vgui.Create("DPanel")
    DPanel_Sell_Tab = vgui.Create("DPanel")
    local shopMenuPanels = {DPanel_Weapon_Tab,DPanel_Weapon_pistols_Tab,DPanel_Weapon_rifles_Tab,DPanel_Weapon_snipers_Tab,DPanel_Weapon_shotguns_Tab,DPanel_Weapon_smg_Tab, DPanel_Ammo_Tab,DPanel_Armor_Tab, DPanel_Sell_Tab}
    ...
    DPropSheet_Shop:AddSheet("Melees", DPanel_Weapon_Tab, "icon16/gun.png", true, true, "Purchase Melees")
    DPropSheet_Shop:AddSheet("Pistols", DPanel_Weapon_pistols_Tab, "icon16/gun.png", true, true, "Purchase Pistols")
    DPropSheet_Shop:AddSheet("Smg", DPanel_Weapon_smg_Tab, "icon16/gun.png", true, true, "Purchase Smg")
    DPropSheet_Shop:AddSheet("Shotguns", DPanel_Weapon_shotguns_Tab, "icon16/gun.png", true, true, "Purchase Shotguns")
    DPropSheet_Shop:AddSheet("Snipers", DPanel_Weapon_snipers_Tab, "icon16/gun.png", true, true, "Purchase Snipers")
    DPropSheet_Shop:AddSheet("Rifles", DPanel_Weapon_rifles_Tab, "icon16/gun.png", true, true, "Purchase Rifles")
    DPropSheet_Shop:AddSheet("Ammo", DPanel_Ammo_Tab, "gui/silkicons/find", true, true, "Purchase Ammo")
    DPropSheet_Shop:AddSheet("Armor", DPanel_Armor_Tab, "gui/silkicons/find", true, true, "Purchase Kevlar")
    ...
    shopTab(DPanel_Weapon_pistols_Tab, "shop_pistols")
    shopTab(DPanel_Weapon_smg_Tab, "shop_smg")
    shopTab(DPanel_Weapon_shotguns_Tab, "shop_shotguns")
    shopTab(DPanel_Weapon_snipers_Tab, "shop_snipers")
    shopTab(DPanel_Weapon_rifles_Tab, "shop_rifles")
    shopTab(DPanel_Ammo_Tab, "shop_ammo")
    shopTab(DPanel_Armor_Tab, "shop_armor")
...
function updateSell()
    ...
    for ItemID, quantity in pairs(Client_Inventory) do
        if quantity > 0 and DayZItems[ItemID] and DayZItems[ItemID].CanBeSold and DayZItems[ItemID].Price and DayZItems[ItemID].Price > 0 then
            local Inventory_Item, dModelPanel_Item = createInventoryButton(125, 125, ItemID, quantity, true, math.floor(DayZItems[ItemID].SellPrice))
