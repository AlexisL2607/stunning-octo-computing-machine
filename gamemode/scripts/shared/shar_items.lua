...
DayZItems[36] = {
    ...
    Model = "models/weapons/w_sv98_tfa.mdl",
    Weight = 35,
    CanBeSold = false,
    Price = 30000,
    SellPrice = 15000,
...
DayZItems[39] = {
    ...
    LootType = "Weapon",
    Gun = true,
    Weapon = "weapon_pistol_silverballer",
}

DayZItems[40] = {
    Name = "Colt 1911 - Manhatten",
    Desc = "A semi-auto pistol that takes Pistol Ammo",
    Model = "models/weapons/ins2/w_duke_m1911_manhatten.mdl",
    Weight = 4.5,
    CanBeSold = true,
    Price = 1500,
    SellPrice = 1500,
    ...
    LootType = "Weapon",
    Gun = true,
    Weapon = "weapon_pistol_1911",
}

DayZItems[41] = {
    Name = "CZ 75 SP01",
    Desc = "A semi-auto pistol that takes Pistol Ammo",
    Model = "models/weapons/w_pist_cz75bsp01.mdl",
    Weight = 4.5,
    CanBeSold = true,
    Price = 3000,
    SellPrice = 1500,
    ...
    LootType = "Weapon",
    Gun = true,
    Weapon = "weapon_pistol_cz75",
}

DayZItems[42] = {
    Name = "Desert Eagle",
    Desc = "A semi-auto pistol that takes Revolver Ammo",
...
DayZItems[43] = {
    ...
    LootType = "Weapon",
    Gun = true,
    Weapon = "weapon_pistol_fiveseven",
}
...
DayZItems[52] = {
    ...
    LootType = "Weapon",
    Gun = true,
    Weapon = "weapon_rifle_an94",
}

DayZItems[53] = {
    Name = "AS VAL",
    Desc = "An automatic rifle that takes Rifle Ammo",
    Model = "models/smc/weapons/asval/w_val.mdl",
    Weight = 25,
    CanBeSold = true,
    Price = 30000,
    SellPrice = 17000,
    ...
    LootType = "Weapon",
    Gun = true,
    Weapon = "weapon_rifle_asval",
}

DayZItems[54] = {
    Name = "MP9",
    Desc = "An automatic SMG that takes SMG Ammo",
    Model = "models/weapons/w_ins2_warface_bt_mp9.mdl",
    Weight = 12,
    CanBeSold = true,
    Price = 5000,
    SellPrice = 2250,
...
DayZItems[55] = {
    ...
    LootType = "Weapon",
    Gun = true,
    Weapon = "weapon_rifle_famas",
}

DayZItems[56] = {
    Name = "FN FAL",
    Desc = "An semi-automatic rifle that takes Rifle Ammo",
...
DayZItems[58] = {
    ...
    LootType = "Weapon",
    Gun = true,
    Weapon = "weapon_smg_mp5a5",
}

DayZItems[59] = {
    Name = "M16A4",
    Desc = "An automatic rifle that takes Rifle Ammo",
    Model = "models/weapons/tfa_ins2_m16/w_m16.mdl",
    Weight = 22,
    CanBeSold = true,
    Price = 25000,
    SellPrice = 10000,
    ...
    useFunc = function(ply, item)
      if ply:Armor() < 100 then
        ply:SetArmor(100)
            ...
            ply:ChatPrint("[DayZ] - You already have more than 100 armor.")
            RunConsoleCommand("dz_GiveItem ".. ply:SteamID64()"98 1")
      end
    end
}
...
DayZItems[72] = {
    ...
    useFunc = function(ply, item)
        if ply:Armor() < 150 then
            ...
            ply:ChatPrint("[DayZ] - You already have more than 150 armor.")
            RunConsoleCommand("dz_GiveItem ".. ply:SteamID64()"99 1")
      end
    end
}
    ...
    useFunc = function(ply, item)
      if ply:Armor() < 250 then
        ply:SetArmor(250)
            ...
            ply:ChatPrint("[DayZ] - You already have more than 250 armor.")
            RunConsoleCommand("dz_GiveItem "..ply:SteamID64()"100 1")
      end
    end
}
...
DayZItems[77] = {
    ...
    LootType = "Weapon",
    Gun = true,
    Weapon = "weapon_smg_ump45",
}

DayZItems[78] = {
    Name = "M40A5",
    Desc = "A powerful bolt-action sniper rifle that takes Sniper Ammo",
    Model = "models/weapons/w_m40a5_tfa.mdl",
    Weight = 28,
    CanBeSold = false,
    Price = 32000,
    SellPrice = 16500,
...
DayZItems[79] = {
    ...
    LootType = "Weapon",
    Gun = true,
    Weapon = "weapon_sniper_m24",
}

DayZItems[80] = {
    Name = "SVD",
    Desc = "A powerful semi-automatic sniper rifle that takes Sniper Ammo",
    Model = "models/weapons/smc/svd/w_svd.mdl",
    Weight = 28,
    CanBeSold = false,
    Price = 42000,
    SellPrice = 22500,
    ...
    LootType = "Weapon",
    Gun = true,
    Weapon = "weapon_sniper_svd",
}

DayZItems[81] = {
    Name = "Tac-338",
    Desc = "A powerful bolt-action sniper rifle that takes Sniper Ammo",
    Model = "models/weapons/w_tac338_tfa.mdl",
    Weight = 28,
    CanBeSold = false,
    Price = 32000,
    SellPrice = 16500,
...
DayZItems[82] = {
    ...
    SpawnChance = 25,
    SpawnOffset = Vector(0, 0, 0),
    Weapon = "tfa_ins2_kabar",
    CanBeSold = true,
}

DayZItems[83] = {
    Name = "M.A.D Prototype TP",
    Desc = "Can teleport you to a safe place.",
    ...
    useFunc = function(ply, item)
        ...
        RandomTpSafezone ={Vector(987, -11961, -600)}
 
        Secs={5,4,3,2,1}
      local random = RandomTpSafezone[math.random(1, table.Count(RandomTpSafezone))]
        for i = 1, 5 do
           timer.Simple( i, function() PrintMessage(HUD_PRINTTALK, "Teleportation in "..Secs[i].." secondes.") end  )
		end
        timer.Simple( 5, function() ply:SetPos( random ) end  )
    end
}
...
DayZItems[85] = {
    Name = "Gauss",
    Desc = "A powerful bolt-action sniper rifle that takes Sniper Ammo",
    Model = "models/weapons/gauss/w_snip_awp.mdl",
    Weight = 28,
    CanBeSold = false,
    Price = 32000,
    SellPrice = 16500,
    ...
    LootType = "Weapon",
    Gun = true,
    Weapon = "weapon_sniper_gauss",
}

DayZItems[86] = {
    Name = "1x Sniper Penetrated Round",
    Desc = "A bullet of sniper.",
    Model = "models/Items/combine_rifle_cartridge01.mdl",
    Weight = 2.9,
    CanBeSold = false,
    Price = 5000,
    ...
    useFunc = function (ply, Amount, AmmoType)
        ply:GiveAmmo(1, "SniperPenetratedRound")
    end
}