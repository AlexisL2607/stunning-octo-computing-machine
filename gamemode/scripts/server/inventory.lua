...
net.Receive("CL_SellItem", function(len, ply)
    ...
    local price = math.floor(DayZItems[itemID].SellPrice) * quantity
    ply:GiveMoney(price)
    ply:TakeItem(itemID, quantity)
    ply:PBroadcast(Color(255, 50, 50), "[DayZ] ", Color(255, 255, 255), "You sold ", Color(50, 255, 50), tostring(quantity), 'x ', DayZItems[itemID].Name, Color(255, 255, 255), " for ", Color(50, 255, 50), '$', tostring(price))
...
function PMETA:BuyItemMoney(ItemID, amount)
    ...
    self:PBroadcast(Color(255, 50, 50), "[DayZ] ", Color(255, 255, 255), "You spent ", Color(50, 255, 50), '$', tostring(DayZItems[ItemID].Price), Color(255, 255, 255), ' on ', Color(50, 255, 50), DayZItems[ItemID].Name, Color(255, 255, 255), "!")
